...
Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/adb-shell-feedstock/blob/master/LICENSE.txt)
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=14043&branchName=master">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/adb-shell-feedstock?branchName=master">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `adb-shell` can be installed with:

```
conda install adb-shell
```

It is possible to list all of the versions of `adb-shell` available on your platform with:
